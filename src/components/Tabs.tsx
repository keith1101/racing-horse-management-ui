...
/** Underlined tab strip, restrained Prism style (never a filled segmented block). */
export function Tabs({ tabs, active, onChange, size = 'md' }: TabsProps) {
  return (
    <div
      className="scroll-slim flex items-center gap-0.5 overflow-x-auto border-b border-[var(--color-border)]"
      role="tablist"
    >
      {tabs.map((t) => {
